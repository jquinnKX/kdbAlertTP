...
.am.onDiskTablePath:hsym`$"C:\\OnDiskDB\\dxAlert_",ssr[;":";""]string[.z.P];
...
/update cumNumAls:reverse sums reverse numals from select numals:count i by floor[orderCount%1000],floor[totalOrderQty%1000],floor[totalOrderValue%1000] from dxAlert

...
/@[system;"l summariseStats.q";show"Error Saving Stats"];
system"l summariseStats.q";

/system"cd C:\\Users\\jason\\Anaconda3\\q\\kdbAlertTP";
show"TASKLIST /FI \"IMAGENAME eq q.exe\" /FI \"PID ne ",string[.z.i],"\"";
system"timeout 2";
tasks:system"TASKLIST /FI \"IMAGENAME eq q.exe\" /FI \"PID ne ",string[.z.i],"\"";
show tasks;
/0N!tasks;
exit[0];
